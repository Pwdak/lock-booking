...
locals {
  ...
  bucket_name  = "${var.project_name}-${random_id.suffix.hex}-frontend"
  frontend_url = "https://${aws_cloudfront_distribution.frontend.domain_name}"
  cors_origin  = var.frontend_origin != "" ? var.frontend_origin : local.frontend_url
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "PRO_PASSWORD", value = var.pro_password },
